...
export const PLATFORM_PROMPTS: Record<string, string> = {
  x: 'Rewrite this into a high-engagement Twitter/X thread. Separate each tweet with <!-- thread-break --> on its own line. Each tweet must be under 280 characters.',
  ...
  linkedin: 'Rewrite this into a professional LinkedIn post. Lead with a strong hook, use short paragraphs, and end with a question or call to action. Max 3000 characters.',
};
